...
service or connector-looking UI is not proof. The router's `fullReady` is a local readiness heuristic,
not an independent remote-read attestation; saved chat metadata alone cannot establish that proof.
Full becomes reusable only after the real workspace
